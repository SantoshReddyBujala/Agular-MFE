...
export class AppComponent implements OnInit, OnDestroy {
  ...
  async ngOnInit() {
    try {
      const listModule = await this.microfrontendService.loadRemoteComponent('movie-list');
      ...
      const availabilityModule = await this.microfrontendService.loadRemoteComponent('ticket-availability');
